...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => [ 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath' ]], function() {
    Route::prefix('dashboard')->middleware('auth')->name('dashboard.')->group(function () {
        ...
        //composer
        Route::get('composer',[AdminController::class,'composer'])->name('composer');
        Route::post('composer/type/check',[AdminController::class,'composerTypeCheck'])->name('composerTypeCheck');

        Route::post('add/work-space',[AdminController::class, 'addNewWorkSpace'])->name('addNewWorkSpace');
        Route::get('get/openai/details/{type?}',[AdminController::class, 'getOpenaiDetails'])->name('getOpenaiDetails');
        Route::post('add/work/space/group',[AdminController::class, 'addWorkSpaceGroup'])->name('addWorkSpaceGroup');
        Route::get('workspace/delete/{id?}',[AdminController::class, 'workspaceDelete'])->name('workspaceDelete');
        ...
        Route::prefix('user')->name('user.')->group(function () {
            ...
            Route::prefix('openai')->name('openai.')->group(function () {
                ...
                Route::middleware('hasTokens')->group(function () {
                    ...
                    Route::get('/generator/{slug}/workbook/{id?}', [UserController::class, 'openAIGeneratorWorkbook'])->name('generator.workbook');
                });
            ...
            Route::prefix('settings')->name('settings.')->group(function () {
                Route::any('/', [UserController::class, 'userSettings'])->name('index');
                Route::any('/save', [UserController::class, 'userSettingsSave']);
                Route::get('/get', [UserController::class, 'userSettings']);
                Route::post('/save_link', [UserController::class, 'saveSocial']);
                Route::post('/save_service', [UserController::class, 'saveServices']);

                Route::any('/password', [UserController::class, 'changePassword'])->name('password');
                Route::any('/update_password', [UserController::class, 'updatePassword'])->name('update_password');
            });
        ...
        Route::prefix('leads')->name('leads.')->group(function () {
            Route::get('/', [LeadsController::class, 'leads'])->name('index');
            Route::get('/addleads', [LeadsController::class, 'addLeads'])->name('add-leads');
            Route::get('/edit/{id}', [LeadsController::class, 'editLeads'])->name('edit');
            Route::get('/delete/{id}', [LeadsController::class, 'deleteLeads'])->name('delete');
            Route::post('/saveleads', [LeadsController::class, 'leadsSave'])->name('saveleads');
            Route::get('/request/{lead_id?}', [LeadsController::class, 'leadRequest'])->name('leadRequest');
            Route::get('/response', [LeadsController::class, 'leadResponse'])->name('leadResponse');
            Route::post('/save_image', [LeadsController::class, 'imageSave']);
            Route::post('/delete_image/{id}', [LeadsController::class, 'imageDelete']);
            Route::get('/status/{lead_id}', [LeadsController::class, 'leadStatus']);
            Route::get('/stripe/{lead_id}/{package_id}', [LeadsController::class, 'createCheckoutSession']); 
            Route::get('/success/{lead_id}/{package_id}', [LeadsController::class, 'stripeSuccess']); 
            Route::get('/cancel', [LeadsController::class, 'stripeCancel']);
            Route::get('/credits/{lead_id}', [LeadsController::class, 'credits']); 
        });
        ...
        Route::prefix('admin')->middleware('admin')->name('admin.')->group(function () {
            ...
            Route::prefix('users')->name('users.')->group(function () {
                Route::get('/list/{type?}', [AdminController::class, 'users'])->name('index');
                Route::get('/add', [AdminController::class, 'usersAdd'])->name('add');
            ...
            Route::prefix('leads')->name('leads.')->group(function () {
                ...
                Route::get('/edit/{id}', [LeadsController::class, 'editLeads'])->name('edit');
                Route::get('/delete/{id}', [LeadsController::class, 'deleteLeads'])->name('delete');
                Route::post('/saveleads', [LeadsController::class, 'leadsSave']);
                Route::post('/save_image', [LeadsController::class, 'imageSave']);
                Route::post('/delete_image/{id}', [LeadsController::class, 'imageDelete']);
                // Route::get('/create', [ServiceController::class, 'create']);
                // Route::post('/save', [ServiceController::class, 'store']);    
            ...
            Route::prefix('settings')->name('settings.')->group(function () {
                ...
                Route::get('/credits', [SettingsController::class, 'credits'])->name('index');
                Route::post('/credit_save', [SettingsController::class, 'creditSave'])->name('credits_save');
                Route::get('/credit_delete/{id}', [SettingsController::class, 'creditDelete'])->name('credit_delete');
                
                Route::post('/save_global_credit', [SettingsController::class, 'SaveGlobalCredits']);

                Route::get('/work', [SettingsController::class, 'KindOfWork'])->name('work');
                Route::any('/save_KindOfWork', [SettingsController::class, 'SaveKindOfWork']);
                Route::any('/delete_KindOfWork/{id}', [SettingsController::class, 'DeleteKindOfWork']);

                Route::get('/property', [SettingsController::class, 'PropertyType'])->name('property');
                Route::any('/save_PropertyType', [SettingsController::class, 'SavePropertyType']);
                Route::any('/delete_propertyType/{id}', [SettingsController::class, 'DeletePropertyType']);
            });
        ...
        Route::prefix('quotations')->name('quotations.')->group(function () {
            Route::get('/my-requests', [QuotationsController::class, 'index'])->name('index');
            Route::get('/dashboard', [QuotationsController::class, 'dashboard'])->name('dashboard');
            Route::get('/refrence', [QuotationsController::class, 'refrence'])->name('refrence');
            Route::get('/stepper', [QuotationsController::class, 'stepper'])->name('stepper');
        });
