...
function sendSupportForm() {
	...
	var status = true;
	if ($('#subject').val() === '') {
		$('#subject').after('<div id="name-error" class="validation-error">Subject is required</div>');
		status = false;
	}

	if ($('#message').val() === '') {
		$('#message').after('<div id="name-error" class="validation-error">Message is required</div>');
		status = false;
	}
