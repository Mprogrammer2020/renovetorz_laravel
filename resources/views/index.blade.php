	...
	<section class="site-section pb-20 pt-32 md:opacity-0 md:translate-y-8 transition-all duration-700 [&.lqd-is-in-view]:opacity-100 [&.lqd-is-in-view]:translate-y-0">
		<div class="container">
			<x-section-header
				...
				subtitle="{!! __($fSectSettings->features_description) ?? __('MagisenseAI is designed to help you generate high-quality content instantly, without breaking a sweat.') !!}"
			/>
	...
	<div class="container">
		<div class="p-10 border rounded-[50px] max-sm:px-6 max-sm:py-16">
			<x-section-header
				...
				subtitle="{{__($fSectSettings->tools_description) ?? __('MagisenseAI has all the tools you need to create and manage your SaaS platform.')}}"
			/>
