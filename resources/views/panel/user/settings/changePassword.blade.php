					...
					<form id="user_edit_form" action="" enctype="multipart/form-data">
                        <div class="col-12">
                            <div class="mb-[20px]">
                                ...
                                <div id="old_password-error" class="validation-error"></div>
                            </div>
                    
                            <div class="mb-[20px]">
                                <label class="form-label">{{__('New Password')}}</label>
                                <input type="password" class="form-control" id="new_password" name="new_password" value="">
                                <div id="new_password-error" class="validation-error"></div>
                            </div>
                            ...
                            <button type="button" form="user_edit_form" id="user_edit_button" class="btn btn-primary w-100" onclick="ChangePassword()">
                                {{__('Save')}}
                            </button>
                        </div>
                    </form>
