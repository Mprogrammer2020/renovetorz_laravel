	...
	<div class="container-fluid">
		<div class="row items-stretch min-h-[100vh] max-lg:pt-32 max-lg:pb-20">
				...
				<div class="row">
					<div class="mx-auto col-lg-6">
						...
						<div class="container-tight">
							<h1 class="mb-11">{{__('Sign up as Contractor')}}</h1>
							...
							<form novalidate="novalidate" method="post">
								...
								<div class="col-12">
    									...
    									<input type="text" class="form-control" id="locationDropdown" name="address" placeholder="Enter a location">
										<div id="name-error" class="validation-error"></div>
										</div>
									</div>
								...
								<div class="row mt-[35px]">
									<div class="col">
										<button type="button" onclick="RegisterForm();" id="RegisterFormButton" class="btn btn-primary w-100">{{__('Sign up')}}</button>
									</div>
								</div>
							</form>
						</div>
			...
			<div class="flex flex-col justify-center overflow-hidden bg-center bg-cover col-lg-6 max-lg:hidden" style="background-image: url(/images/bg/bg-auth.jpg)">
				<img src="/images/bg/dash-mockup.jpg" alt="MagisenseAI Dashboard Mockup" class="rounded-[36px] shadow-[0_24px_88px_rgba(0,0,0,0.55)] translate-x-[27%]">
			</div>
		</div>
	</div>
</div>
...
<script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBdsjb_RUMEkFt5eBE1iyaHrY-FVEiyMSI&libraries=places&callback=initMap">
</script>
@endsection
