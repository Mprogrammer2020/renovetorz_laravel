							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="subject" name="subject"  placeholder="{{__('Please enter subject of the support request')}}">
								...
								<div class="col-md-12">
									<div class="mb-3">
										...
										<textarea class="form-control" name="message" id="message" cols="30" rows="5"  placeholder="{{__('Please enter your message')}}"></textarea>
										<div id="name-error" class="validation-error"></div>
									</div>
								</div>
							</div>
