                    ...
                    <div class="card-body p-10">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <ol>
                                    <li>Download the latest release from <a href="#" target="_blank">CodeCanyon</a>.</li>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.update){
                            ...
                            localStorage.setItem( "MagisenseAI_update_badge", badgeHtml );

                            $('#update_available').show();
                            $('#update_card').show();
                        } else {
                            $('#update_not_available').show();
                            localStorage.removeItem("MagisenseAI_update_badge");
                        }

                        if ( response.description ) {
                            changelog(response.description);
                        } else {
                            $('#update_description').html('<a href="#" target="_blank">Visit Changelog on the Documentation Page</a>');
                        }
                    }
                });
            });
