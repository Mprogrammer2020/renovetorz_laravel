...
@section('content')
    ...
    <div class="page-body pt-6">
        <div class="container-xl">
            <button class="btn btn-primary add-manager-btn" onclick="addManager()">Add User</button>
            <div class="card">
                            ...
                            @foreach($users as $entry)
                                <tr>
                                    ...
                                    <td class="!text-end whitespace-nowrap">
                                        ...
                                        <a href="#" onclick="delete_users({{$entry->id}})" onclick="return confirm('{{__('Are you sure? This is permanent and will delete all documents related to user.')}}')" class="btn w-[36px] h-[36px] p-0 border hover:bg-red-500 hover:text-white" title="{{__('Delete')}}">
