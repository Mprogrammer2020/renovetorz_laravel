...
<?php 
	$checkComposerType = checkComposerType();
	$workSpaceName = workSpaceGroups();
	// dd($workSpaceName);
	// $workbook_id = null;
	// $credit = \App\User::first();
	$credits = DB::table('global_credits')->first();

?>

<div class="loader-area" id="loader-area-id" style="visibility:hidden;">
        ...
        <div class="p-0 container-fluid max-lg:w-full">
            <h1 class="flex items-center ps-[1.25rem] pe-9 min-h-[--lqd-header-height] max-w-full relative max-lg:hidden group-[.navbar-shrinked]/body:w-full group-[.navbar-shrinked]/body:px-0 group-[.navbar-shrinked]/body:text-center group-[.navbar-shrinked]/body:justify-center">
                <a class="block px-0" href="{{ LaravelLocalization::localizeUrl( route('dashboard.index') ) }}">
					...
					@if(isset($setting->logo_dashboard))
						<img src="/{{$setting->logo_dashboard_path}}" @if ( isset($setting->logo_dashboard_2x_path) ) srcset="/{{$setting->logo_dashboard_2x_path}} 2x" @endif alt="{{$setting->site_name}}" class="w-full h-auto group-[.navbar-shrinked]/body:hidden dark:hidden img-size">
					...
					@else
						<img src="/{{$setting->logo_path}}" @if ( isset($setting->logo_2x_path) ) srcset="/{{$setting->logo_2x_path}} 2x" @endif alt="{{$setting->site_name}}" class="w-full h-auto group-[.navbar-shrinked]/body:hidden dark:hidden img-size">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu" >
				...
				@if(Auth::user()->type != 'admin')
                    <li>
                        ...
                        <div class="nav-link-label transition-all">
							<span class="inline-block text-[10px] font-medium uppercase tracking-widest px-[0.5em] py-[0.35em] rounded-[3px]">
								...
								{{__('Manager')}}
								@elseif(Auth::user()->role_id == '3' && Auth::user()->type != 'admin')
								{{__('Contractor')}}
								@endif
							</span>
                        </div>
					...
					@if(Auth::user()->role_id == '2')
					<li class="nav-item">
						 <a class="nav-link {{activeRoute('dashboard.leads.index')}}" href="{{route('dashboard.leads.index')}}">
							<span class="nav-link-icon">
					...
					@if(Auth::user()->role_id == '3' && Auth::user()->type != 'admin')
					<li class="nav-item">
						<a class="nav-link {{activeRoute('dashboard.leads.leadRequest')}}" href="{{route('dashboard.leads.leadRequest')}}">
						   <span class="nav-link-icon">
							   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M3 4m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z"></path> <path d="M5 8v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-10"></path> <path d="M10 12l4 0"></path> </svg>
						   </span>
						   <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
				   ...
				   <li class="nav-item">
					<a class="nav-link {{activeRoute('dashboard.leads.leadResponse')}}" href="{{route('dashboard.leads.leadResponse')}}">
					   <span class="nav-link-icon">
						   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M3 4m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z"></path> <path d="M5 8v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-10"></path> <path d="M10 12l4 0"></path> </svg>
					   </span>
					   <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
...
<!-- 				
				   <li class="nav-item">
						<a class="nav-link" href="javascript:;" id="add_workspace" >
						<span class="nav-link-icon">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M3 4m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z"></path> <path d="M5 8v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-10"></path> <path d="M10 12l4 0"></path> </svg>
						</span>
						<span class="flex items-center transition-[opacity,transform] nav-link-title grow">
				...
				-->
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{activeRoute('dashboard.quotations.index')}}" href="{{route('dashboard.quotations.index')}}" >
						<span class="nav-link-icon">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path> <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0"></path> <path d="M15 15l3.35 3.35"></path> <path d="M9 15l-3.35 3.35"></path> <path d="M5.65 5.65l3.35 3.35"></path> <path d="M18.35 5.65l-3.35 3.35"></path> </svg>
						</span>
                            <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
                    ...
                    @if(Auth::user()->type == 'admin')
						...
						<li class="nav-item">
                            <a class="nav-link {{activeRoute('dashboard.admin.services.index')}}" href="{{route('dashboard.admin.services.index')}}">
								<span class="nav-link-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path> <path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"></path> <path d="M16 3.13a4 4 0 0 1 0 7.75"></path> <path d="M21 21v-2a4 4 0 0 0 -3 -3.85"></path> </svg>
								</span>
                                <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
						...
						<li class="nav-item">
                            <a class="nav-link {{activeRoute('dashboard.admin.leads.index')}}" href="{{route('dashboard.admin.leads.index')}}">
								<span class="nav-link-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path> <path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"></path> <path d="M16 3.13a4 4 0 0 1 0 7.75"></path> <path d="M21 21v-2a4 4 0 0 0 -3 -3.85"></path> </svg>
								</span>
                                <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
						...
						<li class="nav-item">
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.index')}}" href="{{route('dashboard.admin.settings.index')}}">
								<span class="nav-link-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path> <path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"></path> <path d="M16 3.13a4 4 0 0 1 0 7.75"></path> <path d="M21 21v-2a4 4 0 0 0 -3 -3.85"></path> </svg>
								</span>
                                <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
						...
						<li class="nav-item">
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.work')}}" href="{{route('dashboard.admin.settings.work')}}">
								<span class="nav-link-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path> <path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"></path> <path d="M16 3.13a4 4 0 0 1 0 7.75"></path> <path d="M21 21v-2a4 4 0 0 0 -3 -3.85"></path> </svg>
								</span>
                                <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
						...
						<li class="nav-item">
                            <a class="nav-link {{activeRoute('dashboard.admin.settings.property')}}" href="{{route('dashboard.admin.settings.property')}}">
								<span class="nav-link-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round"> <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path> <path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"></path> <path d="M16 3.13a4 4 0 0 1 0 7.75"></path> <path d="M21 21v-2a4 4 0 0 0 -3 -3.85"></path> </svg>
								</span>
                                <span class="flex items-center transition-[opacity,transform] nav-link-title grow">
    ...
    <div class="container-xl flex-nowrap !items-stretch">
		<div class="hidden items-center max-lg:flex max-lg:gap-3">
			...
			<a class="hidden max-lg:flex items-center justify-center shrink-0 lg:px-2 max-md:max-w-[120px]" href="{{ LaravelLocalization::localizeUrl( route('dashboard.index') ) }}">
				<img src="/{{$setting->logo_path}}" alt="MagisenseAI" class="">
			</a>
		</div>
        <div class="navbar-nav flex-row justify-end max-lg:basis-[65%]">
            <div class="flex gap-[18px] max-lg:gap-2 align-area">
				<div class="flex items-center max-xl:gap-2 max-lg:hidden xl:gap-3">
					...
					<a class="btn" href="#" >
						...
						<span class="max-lg:hidden" onclick="showCreditModal()">{{__('Global Credit : ')}} {{$credits->credit_value}}</span>
					</a>
				...
				@if(Auth::user()->role_id == '3')
				<a class="btn avaliable-credits" href="#" >
						<svg class="hidden max-lg:block" xmlns="http://www.w3.org/2000/svg" height="20" fill="currentColor" viewBox="0 96 960 960" width="20"><path d="M690.882 786q25.883 0 44-19Q753 748 753 722.118q0-25.883-18.118-44-18.117-18.118-44-18.118Q665 660 646 678.118q-19 18.117-19 44Q627 748 646 767q19 19 44.882 19ZM689.5 911q33.5 0 60.5-14t46-40q-26-14-51.962-21-25.961-7-54-7-28.038 0-54.538 7-26.5 7-51.5 21 19 26 45.5 40t60 14Zm3 65Q615 976 560 920.5T505 789q0-78.435 54.99-133.718Q614.98 600 693 600q77 0 132.5 55.282Q881 710.565 881 789q0 76-55.5 131.5t-133 55.5ZM480 976q-138-32-229-156.5T160 534V295l320-120 320 120v270q-25-12-52-18.5t-55-6.5q-102.743 0-175.371 72.921Q445 685.843 445 789q0 48 19.5 94t53.5 80q-9 5-19 7.5t-19 5.5Z"/></svg>
						<span id="new_credits" class="max-lg:hidden">Available Credits: {{ Auth::user()->credit > 0 ? Auth::user()->credit : 0 }}</span>
				</a>
				@endif
						

				<!-- <button class="btn btn-primary add-location-btn" onclick="showLocationModal()">Add Location</button> -->
				<div class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-end">
						...
						<a class="dropdown-item {{activeRouteBulk(['dashboard.user.settings.password'])}}" href="{{route('dashboard.user.settings.password')}}" >
							{{__('Change Password')}}
						</a>
      ...
      <div class="modal-body">
        <form action="" id="add_service">
          ...
          <div>
             ...
             <input type="text" name="name" id="postal_code" maxlength="100"><br><br>

			 <label for="name">Distance</label>
             <input type="text" name="name" id="distance" maxlength="100"><br><br>
...
<div class="modal" id="addCreditModal" tabindex="-1">
	<div class="modal-dialog modal-dialog-centered">
	  <div class="modal-content">
		<div class="modal-header">
		  <h5 class="modal-title">Set Global Credit as per Single leads</h5>
		  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		</div>
		<div class="modal-body">
		  <form action="" id="add_credit">
			<input type="hidden" name="credit_id" id="credit_id" value="{{ $credits ? $credits->id : '' }}">
			{{-- <div>
			   <label for="name">Credits </label>
			   <input type="text" name="credit_value" id="credit_value" maxlength="10">
			</div> --}}
			<div class="col-12">
				<div class="mb-[20px]">
					<label class="form-label">{{ __('Credits') }}</label>
					<input type="text" class="form-control" id="credit_value" name="credit_value"
						value="{{ $credits ? $credits->credit_value : '' }}">
		...
		<div class="modal-footer">
		  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
		  <button type="button" class="btn btn-primary" onclick="saveGlobalCredits()">Save</button>
		</div>
	  </div>
	</div>
  </div>

@include('panel.admin.workspace.workspace')
<script>
 function workSpaceName(linkElement) {
        // Get the data-detail attribute value from the clicked <a> element.
        var dataDetail = linkElement.getAttribute('data-detail');
        var dataValue = linkElement.getAttribute('value');

		location.href = "{{route('dashboard.user.openai.list')}}";
}

function addActiveClass(getElementId) {
	var workspace_id = getElementId.getAttribute('data-id');
   $.ajax({
		...
		success: function(response) {
			...
			// Session variable is set successfully
			// You can handle the response here if needed
		}
	});
}
	function showLoader(){
		var loader = document.getElementById("loader-area-id");
