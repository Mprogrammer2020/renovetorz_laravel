        ...
        <div class="content-contents">
            ...
            <div class="content-indent">
                ...
                <div style="padding: 0 19px">
                    ...
                    <p>Thank you for choosing MagisenseAI as your partner in achieving your goals. We look forward to working with you and helping you succeed.</p>
                </div>
                ...
                <?php $url = url('/confirm/email')."/".$user->email_confirmation_code; ?>

                <a href="{{$url}}" class="btn btn-lg btn-block btn-round">
                    Confirm My Account
                </a>
