...
class InstallationController extends Controller
{
    ...
    public function install(Request $request){
        ...
        if (!Schema::hasTable('activity')){
            return 'You are using Plesk for MagisenseAI. It requires MariaDB 10.X or Mysql 5.6,5.7. Please check your mariaDB or Mysql version. After upgrade your mariadb or mysql please reset the table.';
        }
    ...
    public function upgrade(){
        ...
        if ($version > $currentVersion){
            if (!Schema::hasTable('migrations')){
                return 'MagisenseAI is not installed. Install it first. Go to /install';
            }
            ...
            return "<p>MagisenseAI Updated to the version: $version you can go home. The 1.20 update is for testing. If you want to contribute in this system please go to admin and update menu to test autoupdating system.
...
";
    ...
    public function updateManual(){
        ...
        */
        ...
        return "<p>MagisenseAI Updated to the version: $version. Please don't forget to clear your browser cache. You can close this window.";
    }
}
